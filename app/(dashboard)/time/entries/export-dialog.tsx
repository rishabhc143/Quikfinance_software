...
/**
 * ExportTimesheetsDialog — full-featured Export Timesheets modal,
 * mirrors ExportProjectsDialog in shape and field set.
 *
 * Drops any active filters (always exports the whole org). For the
 * filter-aware variant see ExportCurrentViewDialog.
 */
export function ExportTimesheetsDialog({
  trigger,
}: {
    ...
    <Dialog open={open} onOpenChange={setOpen}>
      ...
      <DialogContent className="sm:max-w-md p-0 gap-0 max-h-[90vh] overflow-hidden flex flex-col">
        <div className="px-6 py-4 border-b shrink-0">
          <h2 className="text-base font-semibold">Export Timesheets</h2>
        </div>
        ...
        <div className="px-6 py-4 space-y-5 overflow-y-auto">
          <div className="rounded-md border border-blue-200 bg-blue-50 dark:border-blue-800 dark:bg-blue-950/30 px-3 py-2 text-xs flex items-start gap-2">
            ...
            <span>
              You can export your timesheet data from Quikfinance in CSV, XLS
              or XLSX format. PDF gives you a branded report.
            </span>
          </div>
          ...
          <label className="inline-flex items-start gap-2 cursor-pointer">
            ...
            <span className="text-sm">
              Include Sensitive Personally Identifiable Information (PII) while
              exporting.
            </span>
          </label>
          ...
          <div className="text-xs text-muted-foreground border-t pt-3">
            ...
            the first 25,000 entries. If you have more, please contact support
