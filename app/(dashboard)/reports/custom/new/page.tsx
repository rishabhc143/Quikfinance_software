...
/**
 * REPORTS — "Create Custom Report" page.
 *
 * Reached from the Reports Center modal: the user picks a base report and
 * clicks Proceed, which navigates here with `?base=<reportKey>`. We resolve
 * that key against the static catalog and hand off to the client form.
 * Missing/unknown base → bounce back to /reports.
 *
...
export default async function NewCustomReportPage({
  ...
  return <CustomReportWizard baseKey={base.key} baseName={base.name} />;
}
