...
type WizardProps = {
  ...
  orgName: string;
  /**
   * Current user's display name (or email) — shown in the Step 3 Preview
   * pane when "Generated By" is toggled on.
   */
            ...
            <div className="space-y-4">
              ...
              <aside>
                ...
                <div className="space-y-3 rounded-md border bg-card p-6 shadow-sm">
                  {/* Org header (Organization Name + Org Details + Basis) */}
                  ...
                  {/* Generated meta — only when ≥ 1 of the 3 is checked */}
                  {showGeneratedBy || showGeneratedDate || showGeneratedTime ? (
