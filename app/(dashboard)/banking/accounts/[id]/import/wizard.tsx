...
export function ImportBankStatementWizard({
  ...
  async function onFileChange(file: File | null) {
    ...
    // Parse just the headers + first 10 rows for the preview.
    ...
    const detected = autoDetectColumnMap(head);
    setColumnMap({
      date: detected.date ?? head[0] ?? "",
      description: detected.description,
      reference: detected.reference,
      amountColumnType: detected.amountColumnType ?? "SINGLE_NEGATIVE",
            ...
            <div className="space-y-4">
              <div className="grid gap-3 md:grid-cols-2">
                <div className="space-y-1">
                  <Label htmlFor="file">Upload CSV statement</Label>
                  <Input
                    id="file"
                    type="file"
                    accept=".csv,text/csv"
                  ...
                  <p className="text-xs text-muted-foreground">
                    Max 5 MB. OFX / QIF / PDF support lands in BNK-G.
                  </p>
                </div>
                <div className="space-y-1">
